...
export const metadata: Metadata = { title: "Notifications · Seller" };
...
export default async function VendorNotificationsPage() {
  ...
  return (
    <div>
      <PageHeader title="Notifications" description="New orders, low-stock alerts, reviews and payouts." />
      <div className="grid gap-6 2xl:grid-cols-[minmax(0,1fr)_26rem]">
        ...
        <div className="2xl:sticky 2xl:top-24 2xl:self-start">
          <NotificationPrefsForm initial={prefsRow?.prefs ?? defaultNotificationPrefs} isVendor />
        </div>
      </div>
    </div>
  );
